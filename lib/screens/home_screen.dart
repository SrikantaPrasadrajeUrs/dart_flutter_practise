...
class _HomeScreenState extends State<HomeScreen> {
  ...
  final Map<String, bool> selectedNotes = {}; // ui
  final Set<String> idsToDelete = {}; // fucntionality
  // id: true
  // id: false
  ...
  void deleteNote(String id) => notesRepo.delete(id: id);
              ...
              itemBuilder: (context, index) {
                ...
                return Container(
                  ...
                  child: ListTile(
                    ...
                    leading: Checkbox(
                      value: selectedNotes[note.id] ?? false,
                      onChanged: (value) {
                        setState(() =>selectedNotes[note.id] = value!);

                        //----------------------------------------------
                        if(value==true){
                          idsToDelete.add(note.id);
                        }else if(value==false){
                          idsToDelete.remove(note.id);
                        }
                      },
                    ),
